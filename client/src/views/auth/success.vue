            ...
            <b-card no-body>
                <b-card-body class="p-0 bg-black auth-header-box rounded-top">
                    <div class="text-center p-3">
                        ...
                        <h4 class="mt-3 mb-1 fw-semibold text-white fs-18">Success!</h4>
                    </div>
                </b-card-body>
                <b-card-body class="pt-4">
                    <div class="alert alert-info">
                        <p>You have correctly answered your questions. Check your sms and email for further steps!</p>
                    </div>
                </b-card-body>
            </b-card>
        </b-col>
