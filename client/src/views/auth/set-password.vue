      ...
      <b-card no-body>
        <b-card-body class="p-0 bg-black auth-header-box rounded-top">
          <div class="text-center p-3">
            ...
            <h4 class="mt-3 mb-1 fw-semibold text-white fs-18">Set password</h4>
        ...
        <b-card-body class="pt-0">
          <b-form class="my-4" @submit.prevent="set_password()">
            ...
            <div class="mb-2">
              ...
              <input type="text" v-model="credentials.national_id" required class="form-control form-control-sm" />
            </div>
            <div class="mb-2">
...
const set_password = async () => {
  ...
  try {
    ...
    apiState.setErrors([]);
    const response = await authService.setPasswordApi(data);
